...
import { useAdminLoginMutation } from '@/app/admin/store/api/schoolsApi';
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const loginSystemAdmin = async (email: string, password: string) => {
    ...
    try {
      ...
      if (!success.error) {
        ...
        if (adminData.adminType !== 'system_admin') {
